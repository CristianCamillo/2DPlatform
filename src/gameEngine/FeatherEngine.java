...
public class FeatherEngine implements KeyListener, MouseListener
{
	...
	public FeatherEngine(int width, int height, String title, int FPSCap, boolean showFPS, boolean fullscreen, boolean useBuffer)
	{		
		this.width = width;
		this.height = height;
	...
	public final boolean isUseBuffer()		   { return useBuffer; }
	...
	public final void setFPSCap(int FPSCap) throws IllegalArgumentException
	{
		if(FPSCap < 0)
			throw new IllegalArgumentException("FPSCap cannot be less than 0");
	...
	public final void setUseBuffer(boolean useBuffer)
	{
		this.useBuffer = useBuffer;
	}
